      ...
      gsap.to(tValuesObject, {
        ...
        onUpdate: () => {
          ...
          if (lightObject) {
            ...
            if (t === 1) {
              // Emit light smoothly after reaching the end of the curve
              gsap.to(lightObject.light, {
                intensity: 1, // Target light intensity
                duration: 0.2, // Duration of the light emission
                ease: "power1.inOut"
              });
            }
          }
